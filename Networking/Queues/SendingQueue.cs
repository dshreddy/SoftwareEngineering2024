...
public class SendingQueue
{
    ...
    private readonly static int s_highPriorityValue = 2;
    private readonly static int s_lowPriorityValue = 1;

    // Stores the sums of priorities, which is used in the 'Dequeue' function
    private readonly static int s_totalRatio = s_highPriorityValue + s_lowPriorityValue;
